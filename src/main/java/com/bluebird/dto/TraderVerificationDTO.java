...
public class TraderVerificationDTO {
	...
	private List<TraderBranchDetailsDTO> traderBranchList; 
	...
	public List<TraderBranchDetailsDTO> getTraderBranchList() {
		return traderBranchList;
	}

	public void setTraderBranchList(List<TraderBranchDetailsDTO> traderBranchList) {
		this.traderBranchList = traderBranchList;
	}
